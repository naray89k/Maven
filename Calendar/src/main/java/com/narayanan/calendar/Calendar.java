package com.narayanan.calendar;
...
public class Calendar {
	 ...
	 * @param year
	 */
	public Calendar(long month, long year) {
		this.month = month;
		this.year = year;
	}
	...
	public long totalDays(){
		...
		if(year<1752){
			System.out.println("Calendar date cannot be found before 1753");
			System.exit(1);
		}
		if(year>=1752){
			if(year%4==0){
	...
	void displayMonth(){
	 ...
	 public static void main(String[] args){
		...
		if (args == null)
			...
			System.out.println();
			for(int j=1;j<13;j++){
				Calendar cal = new Calendar(j,year);
				cal.displayMonth(); 
				System.out.println();
			}
		}
